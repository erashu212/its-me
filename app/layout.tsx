...
export const metadata: Metadata = {
  ...
  title: {
    default: `${profile.name} - Founder of Rigour & Rigovo | Full-Stack Engineer & Technical Founder`,
  ...
  openGraph: {
    ...
    siteName: `${profile.name} - Founder of Rigour & Rigovo`,
    title: `${profile.name} - Founder of Rigour & Rigovo | Technical Founder & Full-Stack Engineer`,
    description: profile.summary,
    images: [
      {
...
function generateStructuredData() {
  return [
    // Person Schema
    {
      ...
      '@type': 'Person',
      name: profile.name,
      jobTitle: 'Technical Founder & Full-Stack Engineer',
      description: profile.summary,
      url: 'https://erashu212.vercel.app',
      image: profile.image,
      email: profile.email,
    ...
    // WebSite Schema
    {
      '@context': 'https://schema.org',
      '@type': 'WebSite',
      name: `${profile.name} - Founder of Rigour & Rigovo`,
      url: 'https://erashu212.vercel.app',
      description: profile.summary,
      author: {
        '@type': 'Person',
